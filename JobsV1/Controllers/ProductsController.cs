...
namespace JobsV1.Controllers
{
    public class ProductsController : Controller
    {
        ...
        private List<SelectListItem> ProductStatus = new List<SelectListItem>
        {
        ...
        {
            ViewBag.Status = new SelectList(ProductStatus, "Value", "Text");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "Id,Code,TemplateId,Description,Remarks,Sort,Status")] Product product)
        {
        ...
        public ActionResult Edit(int? id)
        {
            ...
            ViewBag.Status = new SelectList(ProductStatus, "Value", "Text", product.Status);
            return View(product);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Code,TemplateId,Description,Remarks,Sort,Status")] Product product)
        {
            if (ModelState.IsValid)
            {
